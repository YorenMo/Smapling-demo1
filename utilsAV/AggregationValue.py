...
def evaluate_results(model, number_initial_points= 10, num_plot_markers=20, num_interval_points=1,directory='.', task='Classification'): #
    ...
    sio.savemat(directory+'/plot_points.mat',{'plot_points':plot_points})
    ...
    sio.savemat(directory+'/Random_scores.mat',{'Random_scores':RD_scores})
    sio.savemat(directory+'/HighSV_scores.mat',{'HighSV_scores': HighSV_scores})
    sio.savemat(directory+'/Cluster_scores.mat',{'Cluster_scores':Cluster_scores})
